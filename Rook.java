...
public class Rook implements Piece{
    ...
    private String symbolW = "2656";
    private String symbolB = "265C";
    private Piece[][] grid;
    ...
    public Rook(int x, int y, int color, Piece[][] grid){
        this.x = x;
        this.y = y;
        this.color = color;
        this.grid = grid;
    ...
    public Piece create(int x, int y, int color){
        return new Rook(x, y, color, this.grid);
    }
    ...
    public Piece copyPiece(Piece[][] grid) {
        return new Rook(this.x, this.y, this.color, grid);
    }
